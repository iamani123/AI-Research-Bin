...
class A3CAgent:
    ...
    def train(self):
        ...
        while True:
            ...
            pylab.savefig("./graphs/cartpole_a3c.png")

            self.save_model('./models/cartpole_a3c.h5')
        ...
        while episode < EPISODES:
            ...
            while True:
                ...
                if done:
                    ...
                    timetake=timetake[5:]
                    print("episode: ", episode, "/ score : ", score, "/ time : ", timetake)
                    self.train_episode(score != 500)
                    acc[0,episode] = episode
                    acc[1,episode] = score
                    acc[2,episode] = timetake
                    if np.mean(scores[-min(10, len(scores)):]) > 490:
                        np.savetxt("Time_a3c.csv", acc, delimiter=',')
                        sys.exit()
                    break
